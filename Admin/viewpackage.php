...
<tr><td class="toptd">View Students</td></tr>
...
$s="select * from login WHERE status='student'";
...
while($data=mysqli_fetch_array($result))
{
		...
		echo "<tr><td style=' padding:5px;'>$data[0]</td><td style=' padding:5px;'>$data[1]</td><td style=' padding:5px;'>$data[2]</td><td style=' padding:5px;'>$data[6]</td></tr>";
