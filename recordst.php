...
?>  
			<form method="post" action="stmarks.php" >
			...
			<td><input type="hidden" value="<?php echo $row["email"]; ?>" name="emailst"></td>
			<td><input type="hidden" value="<?php echo $row["photo"]; ?>" name="photo"></td>
<td><input type="hidden" value="<?php echo $row["name"]; ?>" name="name"></td>
<td><input type="hidden" value="<?php echo $row["phone"]; ?>" name="phone"></td>			
